...
| # | Skill | 类型 | 调用方式 | 来源 | Stars |
|---|-------|------|---------|------|-------|
| 1 | **agent-skill-creator** | 第三方 | `/agent-skill-creator` | [FrancyJGLisboa/agent-skill-creator](https://github.com/FrancyJGLisboa/agent-skill-creator) | 1.2K ⭐ |
| 2 | **brainstorming** | 第三方 | `/brainstorming` | [obra/superpowers](https://github.com/obra/superpowers) | 210K ⭐ |
| 3 | **concise-response-skill** | 自建 | `/concise-response` | — | — |
| 4 | **find-skills** | 官方 | 自然触发 | [vercel-labs/skills](https://github.com/vercel-labs/skills) | 20.4K ⭐ |
| 5 | **frontend-design** | 官方 | 自然触发 | [anthropics/claude-code](https://github.com/anthropics/claude-code) | 127K ⭐ |
| 6 | **ui-ux-pro-max** | 第三方 | 自然触发 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 83.9K ⭐ |
| 7 | **hud-skill** | 自建 | `/hud-skill show`, statusLine | — | — |
